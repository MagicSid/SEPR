...
public class BaseActor extends Group {
    ...
    public void copy(BaseActor original) {
        if (original.region.getTexture() != null) this.region = new TextureRegion(original.region);
    ...
    public void setParentList(ArrayList<? extends BaseActor> pl) {parentList = pl;}
