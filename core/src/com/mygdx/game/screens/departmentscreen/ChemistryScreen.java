...
public class ChemistryScreen extends BaseScreen {

    private SailingScreen sailingScreen;

    public ChemistryScreen(BaseGame g, SailingScreen sailingScreen) {
        super(g);
    ...
    public void create() {
        ...
        String text = "Welcome to the Chemistry Department. Press B to buy upgrade, ESC to exit";
